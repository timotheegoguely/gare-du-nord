...
public class horaires_departs extends PApplet {
...
{
  String[] lignes = loadStrings("http://www.gares-en-mouvement.com/fr/frpno/horaires-temps-reel/dep/");
  rawPage = join(lignes, "");
}
...
public void table_csv()
{
  ...
  saveTable(table, "/Users/timotheegoguely/Dropbox/\u00c9SAD/DNSEP/Projet/Gare du Nord/Data/horaires_departs/data/horaires_departs_"+y+"-"+m+"-"+d+"_"+h+"."+min+"."+sec+".csv");
...
/**
*  sert \u00e0 stocker les donn\u00e9es extraites de la page http://www.gares-en-mouvement.com/fr/frpno/horaires-temps-reel/dep/
*/
class GareData
{
  String type;
  ...
  */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "horaires_departs" };
    if (passedArgs != null) {
